...
2. Specs/docs confirmed: the spec's §Verification (`specs/SPEC-030-record-hygiene-working-set-scope.md:358-382`) and Deliverable 6 capstone bullet (`:337-340`) enumerate the cross-surface regression checks this ticket pins.
