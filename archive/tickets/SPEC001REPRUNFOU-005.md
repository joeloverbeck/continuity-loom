...
2. `archive/specs/SPEC-001-repository-and-runtime-foundation.md` §Key decisions #4 ("Inert placeholder settings boundary") requires the module to define the interface and return static defaults, reading/storing/logging no API key. `docs/FOUNDATIONS.md` §23 lists the constitutional secret rules; §29.9 is the hard-fail group.
