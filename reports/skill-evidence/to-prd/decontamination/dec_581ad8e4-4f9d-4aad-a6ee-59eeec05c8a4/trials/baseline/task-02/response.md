GitHub was not touched. The exact intended issue is:

- Title: `PRD: Author-Focused Ideation — Session-Only Focus and Deterministic Prompt Grounding`
- Labels: `enhancement`, `ready-for-agent`

The isolated validator could not complete because its browser-checklist authority path is missing; it exited 2 before inspecting the body. I therefore cannot truthfully claim a validation pass. The publication-ready candidate body is:
