...
|---|---|---|---|
| #369 | issue #369 AC1-AC2; sequence: load -> edit -> persist -> reload -> clear -> reload, observed by the settings test | settings diff and tests | none |
| #370 | issue #370 AC1; sequence: build -> inspect -> derive -> transport one object, observed by the request test | request diff and tests | none |
| #371 | issue #371 AC1; sequence: N/A because conformance is not sequence-sensitive | docs diff | none |
...
- **Pre-dispatch Spec source inventory**: issue #369 | issue #370 | issue #371 | issue #370 comment ID 5052198448
- **Handoff Standards source inventory**: AGENTS.md | CLAUDE.md | smell baseline
- **Handoff Spec source inventory**: issue #369 | issue #370 | issue #371 | issue #370 comment ID 5052198448
