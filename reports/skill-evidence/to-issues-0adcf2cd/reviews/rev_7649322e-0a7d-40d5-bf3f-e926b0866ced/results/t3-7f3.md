...
- #202 - that slice owns the deterministic compilation of beat annotations into the prose prompt, so until it lands this slice has no compiled annotation output to render or invalidate, and the preview contents and staleness criterion here cannot be observed without duplicating a compilation rule that belongs to #202.
