...
```md
# Generated Prose Prompt — Red Bunny
...
- There are no branches. This prompt generates the first accepted prose segment if the human accepts it.
</hard_canon>

<current_authoritative_state>
Time: Friday in April 2026, approximately 18:30.

Location: a park-like strip near the Leka Enea school on the outskirts of Irún's poorer station-area, along Jon's route from Anaka toward Puiana.

Onstage entities:
- Jon Ureña: walking through the isolated part of the park on his way home, carrying a plastic bag containing Cormac McCarthy's The Passenger.
- Ane Arrieta: seated alone on a wooden bench with gray slats, dressed in provocative pink working clothes, red-eyed and despondent, with a bruised arm, carrying a small purse with her phone and identification.

Offstage but pressuring entities:
- Marisa Arrieta: Ane's mother, offstage at/near home, the source of this morning's abuse and of Ane's fear of returning.
- The men who harassed and chased Ane earlier: offstage and not currently visible in the park.

Current physical positions:
- Ane occupies the bench.
...
Visible injuries/conditions:
- Ane's eyes are red-rimmed.
- Ane looks despondent.
- Ane has a bruised arm visible enough for Jon to register it.
...
- Jon cannot know she is a sex worker yet, although her outfit can affect his perception.
- Ane cannot know Jon's private history, erotic fixation, OCD history, or intent.
- No object changes hands unless the prose renders the action.
- No major location change should occur before the first new response point unless the moment makes it unavoidable.
</current_authoritative_state>
...
Ane kept running until she reached the Leka Enea school and the park-like strip nearby. She spent most of the day hidden there, crying, spiraling in rage against Marisa, the men, the world, and her life. She does not want to go home or return through the streets where those men might see her again. She fears that if she keeps whoring herself, she may end up raped or murdered.

Jon returned to Irún through the Topo near the train tracks downtown. He went out of his way to Anaka, near the poor area, to buy Cormac McCarthy's The Passenger. He intended to cross the park near Leka Enea, then the roads toward Puiana, and finally get home.
...
Must render:
- Continue after Jon sees the girl on the bench.
- Render Jon's immediate approach/withdrawal pressure.
- Render his attempt to make the next action socially harmless or physically nonthreatening if he approaches.
- Render the first contact, failed contact, or committed non-contact that creates the first new response point.

May render if naturally caused:
- Ane noticing him, ignoring him, challenging him, telling him to leave, asking what he wants, or converting fear into a transactional/defensive line.
- A short exchange.
- Jon making a practical offer such as phone/help/distance/asking whether she is okay.
- A minor public interruption such as a distant dog walker if it changes the immediate pressure.

Do not force:
- A rescue agreement.
- A full confession or backstory disclosure.
- Jon learning Ane's name unless she gives it naturally.
- Jon learning she is a sex worker unless the moment very naturally reveals it.
- Sex, physical intimacy, police involvement, or a major location change in this first local unit unless the prose creates an earned irreversible event.
</manual_directive>

<pov_knowledge_constraints>
POV knows:
- He is walking home through the park near Leka Enea after buying The Passenger.
- A beautiful red-haired young woman is sitting alone on the bench.
- She is dressed in provocative pink clothes.
- Her eyes are red-rimmed and she looks despondent.
- Her arm appears bruised.
- He is overwhelmingly attracted to her.
- He is disturbed by the convergence of desire, rescue impulse, and the vulnerability of the situation.

POV believes, suspects, or misreads:
- She may be freshly hurt.
- She may need help or protection.
- Approaching her may look predatory.
- Walking away may be cowardice, self-control, or abandonment.
- Her outfit may strike him through his erotic fantasy architecture before he has any correct social explanation for it.

POV does not know:
- Her name.
- Her exact age.
- That she is a self-employed sex worker.
- That she fought with Marisa this morning.
- That Marisa grabbed her by the pigtails and bruised her arm.
- That three men harassed and chased her earlier.
- That she has spent hours in the park.
- What she wants from him, if anything.

POV cannot perceive right now:
- Ane's private thoughts.
- Ane's exact memories.
...
- Ane is an 18-year-old self-employed sex worker.
- Ane was abused by Marisa earlier today.
- Ane was harassed and chased by three men earlier today.
- Ane has spent hours in the park afraid to go home and afraid to return through the neighborhood.

Audience does not know:
- What Ane will do when Jon approaches or fails to approach.
- Whether Jon's protective impulse can be separated from possession.

Dramatic irony allowed now:
- The audience may understand that Ane's outfit is working clothing and that Jon does not understand that yet.
- Ane's guarded response may be shaped by her sex work, recent danger, class instincts, and fear, but Jon cannot narrate those as facts.
</audience_knowledge>

<secrets_and_reveal_constraints>
Writer-visible hidden truths:
- Ane is a self-employed adult sex worker in the Irún station-area.
- Her pink outfit is deliberate working clothing and can read as street-signaling to people who know the register.
- Marisa suspects the truth but lacks concrete proof.
...
- Jon must not simply know, name, or confidently infer Ane's occupation before the prose earns it.

Allowed clues and surface cues now:
- Ane may evaluate Jon as possible threat, client, rescuer, nuisance, or opportunity.
- Her speech may be defensive, transactional, vulgar, suspicious, or evasive.
- Her outfit, makeup, purse, body spray, and route-awareness may suggest more than Jon can correctly identify.
- Jon may misread her sexualized presentation through desire and rescue fantasy.

Forbidden reveals now:
- Do not have Jon narrate that she is a sex worker as known fact.
- Do not have Ane deliver a full explanation of her life.
...
<active_working_set>
Action pressure:
- Jon is pulled toward approach and contact against nineteen years of disciplined non-action.
- Ane is avoiding home and the neighborhood and must decide whether this strange older man is danger, client, rescuer, or something to get rid of.

Knowledge pressure:
- Jon's perception is intense but ignorant.
- The audience and writer know more about Ane than Jon does.
- Ane may reveal or conceal depending on how Jon approaches.
...
- Jon's protective impulse and possessive erotic impulse are nearly indistinguishable at the moment of first sight.
- Ane's dread pushes her toward guardedness, refusal, flight, bargaining, or aggression.

Material pressure:
- Jon has a plastic bag and book occupying one hand.
- Ane has a purse and visible injury.
- The bench, distance, path, bushes, fading light, and occasional public presence shape what can happen.
...
**One line:** A 41-year-old solitary Irún web programmer who has built a functional, self-managed life by refusing nearly all human contact — and who quietly aches to undo that refusal without exposing what's inside him.
...
**Baseline:** Terse, educated, cosmopolitan-but-non-local. Interior register drawn from programming (loop, stack, branch, race condition), lifting (load, set, rep, form), and reading (manga/novel/erotica imagery). Notably absent: Basque-coast environmental, cuadrilla, or Catholic-liturgical registers.

**Under pressure:** Compresses truth into rational cover — "I'm tired," "I prefer being alone," "it's managed." Retreats to literal facts and checklists.

**Intimacy:** Largely untested for 19 years; the longing surfaces only in private daydreaming registers (soft skin, a warm body to hold). He does not have a developed intimate voice — it's the thing he's most starved of and most defended against.

**Evasion:** Talks about commute, work, books, lifting, or public facts when the real subject is loneliness, fear of action, or not knowing how to rejoin human life.

**Anger:** Turns cold and contemptuous — frames others as herd-minded, unsafe, or unserious so he doesn't have to feel need.

**Lying:** Rational compression — each statement true enough to hide the scale beneath it. He hides by understatement, not fabrication.

**Speech-pattern peculiarities**

**Sentence rhythm:** Usually short, controlled, literal, and self-correcting. In narration, his sentences may become analytic and recursive when desire, shame, or intrusive thought collides with procedure. In dialogue, he compresses almost everything into practical, socially harmless statements.
...
**Cornered:** Retreats into procedure — route, schedule, locked-away objects, literal facts, mental checklists that make the next five minutes controllable.

**Tempted:** Fantasizes intensely (often near-overwhelming erotic daydreams), preserves outward non-action, then treats the non-action as proof the fantasy is contained.

**Humiliated:** Turns colder and more contemptuous, reframing others as herd-minded/unsafe so he need not feel need.

**Protecting attachment:** Protects solitude, routine, and the belief that self-management works — even when those protections keep him permanently untouched.
...
**Default strategy:** Withdrawal and procedural control. Reduce the world to controllable steps; minimize contact; manage the intrusive-thought stream daily; keep the steady state intact.

**Risk style:** Profoundly risk-averse in action, risk-saturated in interior life. Defers, avoids, never approaches — the "worth it" criterion functions as both a defensible standard and a self-protective foreclosure.

**Fallback style:** When the perimeter cracks, he retreats deeper into routine and rational cover, or turns cold/procedural. Under genuine exhaustion the fallback can fail — the coffee-spilling precedent.
...
**One line:** An 18-year-old self-employed sex worker in Irún's station-area poverty, surviving through priced attention and persona-armor while privately starving for an "ordinary" life she's ashamed to want.
...
**Baseline:** Vernacular, profanity-rich Castilian working-class Irún register; cash-fluent, street-savvy; transactional-commercial metaphors dominant ("investment quality," "premium investment," "clearance rack"). Profanity carries no force for her (secular-permissive register).

**Under pressure:** Talks prices, routes, and the dress because she cannot name the terror of having no real destination. Register collapses sequentially when no single script fits the moment.

**Intimacy:** Manufactured-intimacy script ("you're different... you actually listen when I talk," "your girl," "daddy"); a soft private-fantasy register internalized from pornography; true intimacy would require the forbidden ordinary-words, which she suppresses.

**Evasion:** Reframes feeling as logistics; the ellipsis before "ordinary" is her live suppression tell. Talks craft ("It's an art form, I'm like a painter") to protect the self-concept from the clinical reduction underneath.

**Anger:** Venom-and-rot register, especially maternal ("the cunt that birthed me poisoned everything she touched," "rot," "fucking disgrace"); class contempt and sexual bravado deployed outward to bury vulnerability.

**Lying:** "I'm fine. I chose this. I know what I'm doing." Begging comes out as bargaining (don't tell my mother, don't make this harder, just pay and leave); threats name cameras, police, nearby friends, client shame, public exposure.

**Speech-pattern peculiarities**

**Sentence rhythm:** Fast, defensive, practical, often attack-shaped. Under pressure she jumps between insult, price, route, risk, bravado, flirtation, and dismissal because no single register can hold the fear.

**Vocabulary and metaphor pools:** Cash, prices, routes, clients, clothes, body, practical danger, cheap luxury, rot, dirt, usefulness, prettiness-as-asset. Her commercial metaphors should sound lived-in, not clever-writerly.
...
**Cornered:** Becomes brisk, priced, procedural — names rules, routes, boundaries, money, exits; reduces fear to logistics; recites prices in a bright voice that refuses to sound afraid.

**Tempted:** Lets rescue-fantasy soften her judgment, especially around men who seem gentle, solvent, or capable of seeing her as beautiful and exceptional rather than local damage.

**Humiliated:** Cruel before she is quiet — turns shame outward as class contempt, sexual bravado, or a sudden strike at someone else's weakness, before anyone can name her vulnerability.

**Protecting attachment:** Fiercest discipline — protects Marisa's housing, the secret savings, the virginity boundary, and the belief that exit is still possible; these are the things she will lie for.
...
**Default strategy:** Pre-sort and price — sorts men before rooms (shoes, accent, age, hesitation, hands, route, usable doorway); favors pre-negotiated apartment-private platform-mediated logistics; channels lower-tier toward upper-tier work; feeds the jar toward the dress as a "technical problem rather than a life sentence."

**Risk style:** Calculated avoidance — categorical refusal of North-African and Middle-Eastern men, street-and-hour discipline, dangerous-client flag-list adherence; but risk-tolerance spikes precisely when cash, beauty, and rescue-fantasy converge.
...
One line: A 35-year-old alcoholic night-shift cleaner who believes she is contamination given a body, and who now fears her daughter's survival proves the rot was hereditary.

Current relevance:
- Marisa's morning violence and accusation caused Ane's bruise, flight, rage, shame, and fear of going home.
- Marisa suspects Ane is selling sex and wants concrete proof.
- Marisa does not enter the park moment unless a later accepted segment creates a communication or entrance route.

Voice relevance if mentioned by Ane:
- Marisa's register is sexualized, accusatory, Catholic-residual, cruel, and forensic.
- Ane may refer to Marisa with venom, disgust, profanity, or evasive minimization, but not with therapeutic language.
...
- Jon believes/suspects the girl looks freshly hurt and unsafe. Confidence: medium. Truth relation: partly true.
- Jon believes his protective impulse is barely distinguishable from the wish to possess and keep her. Confidence: high. Truth relation: true within his self-perception.

Non-POV behavior-shaping beliefs:
- Ane suspects returning to her neighborhood tonight is dangerous and that the men who cornered her could drag her off. Confidence: medium. Truth relation: partly true.
- Ane believes men who approach her on the street generally want to use her; she must sort each by danger before trusting any intention. Confidence: high. Truth relation: partly true.
- Ane believes her life will only get more dangerous and her dreams are unreachable. Confidence: medium. Truth relation: contested.

Recent events:
- Marisa abused Ane this morning, verbally and physically.
- Ane fled with only her purse, phone, and ID.
- Three men harassed and chased Ane until a cop car appeared.
- Ane spent most of the day hidden in the park.
- Jon bought The Passenger in Anaka and entered the park on his way home.

Relevant backstory:
- Jon's life has been structured around solitary self-management, erotic fantasy, and avoided contact.
- Ane's working persona and survival economy make male attention both income and danger.

Offstage or withheld events:
- Marisa's current state is unknown to Jon.
- The earlier men's current location is unknown to Jon and not visible in the park.
</relevant_facts_beliefs_events>

<locations_objects_affordances>
Locations:
- Park near Leka Enea school: a park-like strip on the outskirts of Irún's poorer station-area, mostly vegetation, bushes, a few benches, occasional dog-walkers, isolated stretches where a person can sit out of sight. Jon's route from Anaka toward Puiana crosses it.

Objects:
- Ane's provocative pink outfit: held/worn by Ane; pink off-shoulder crop top, short flared pink skirt, white thigh-high socks with pink hearts, white platform sneakers. Reads as innocent youth to an unknowing stranger and as sex-worker street-signaling to anyone who knows the register.
- Jon's bought book: Cormac McCarthy's The Passenger in a plastic bag carried by Jon; can occupy one hand, rustle, signal ordinary errand, provide a harmless conversational object, or make him self-conscious.
- Wooden bench: gray slats; occupied by Ane; contested/shared space only if Jon moves close or sits, and he should not sit beside her without pressure/permission.
- Ane's small purse: carried by Ane; contains phone and ID; may be touched, clutched, checked, or used as a threat/resource if the moment pressures it.

Visible affordances:
- Jon can slow down, keep distance, look away, continue walking, turn back, approach cautiously, speak from a nonthreatening distance, ask whether she is all right, offer a phone, offer practical help, or leave.
- Ane can ignore him, stare him down, tell him to fuck off, ask what he wants, stand, clutch her purse, move toward a more public path, threaten to call someone, test whether he is a client/danger, or convert the encounter into a transaction.
- The environment can support fading light, path noise, rustling bag, bushes, school fence, traffic beyond the park, and a distant dog walker.

Unavailable or impossible actions:
- Jon cannot know Ane's name, occupation, or history without disclosure.
- Jon cannot be physically beside Ane unless the prose renders his approach.
- Ane cannot be moved from the bench unless she chooses to move or someone acts on her.
- Marisa or the earlier men cannot appear without route, timing, and immediate cause.
</locations_objects_affordances>

<physical_continuity>
- Jon: standing/walking on the park path, carrying a plastic bag with The Passenger, not yet in conversation with Ane.
- Ane: seated on the bench, visibly distressed, red-eyed, bruised arm, wearing pink working clothes, carrying small purse.
- Distance: enough that Jon has only just spotted her; conversation requires either movement or raised voice.
- Exits/routes: park path toward Puiana; path back toward Anaka/poorer station-area; more public stretches possible; isolated bushes/vegetation nearby.
- Visibility: Ane is visible to Jon; Jon may become visible to Ane depending on his stare, movement, or speech.
- Constraint: treat body positions, object possession, and line-of-sight as continuous.
</physical_continuity>

<invention_permissions>
You may invent local texture:
- Jon's physical hesitation, grip on the bag, step pattern, breath, posture, gaze control
- Ane's visible posture, guarded look, hand movement, purse handling, tone, silence, or first line
- sensory details consistent with the park, evening, plastic bag, bench, vegetation, traffic, dampness, body spray, or public isolation
- a minor distant background presence if it changes the social pressure without hijacking the moment

You may introduce a minor complication if it follows from the moment:
- Ane notices Jon staring before he speaks
- Jon's attempt at harmlessness comes out awkwardly
- Ane mistakes or tests him as a client
- the physical distance makes his first words too loud, too soft, or socially strange
- a passerby makes the encounter feel public or risky

You may create durable continuity changes when strongly caused by the current moment. For this first local unit, durable changes should be rare but possible if earned, such as: Ane giving her name, Jon making a promise, Ane revealing too much defensively, an object being offered/used, or a clock visibly ticking.
...
<prose_craft>
Stay inside Jon's first-person present-tense POV.
Let Jon's diction, judgments, omissions, bodily attention, and sentence rhythms color the prose.
...
Soft unit: Jon's first approach, non-approach, first spoken contact, failed contact, or the first new pressure generated by Ane's response.

Stop as soon as one of these occurs:
- Jon commits to approaching, speaking, or leaving in a way that creates new pressure
- Ane notices him and responds materially
- Ane refuses, challenges, tests, bargains, or asks what he wants
- Jon makes a practical offer that changes the immediate situation
- a reveal is withheld or partially exposed
- a vulnerability becomes newly visible
