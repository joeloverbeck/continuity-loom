...
function renderPrompt(
  ...
  return [
    ...
    `Exact saved must_render requirements: ${canonicalData(outputGuidance.mustRender)}`,
    ...
    "Treat the saved local moment as binding source constraints, not optional inspiration.",
