...
export const DIAGNOSTIC_CODES = Object.freeze({
  ...
  relationshipSelfReference: "relationship-self-reference",
  ...
  recordReferenceUnselectedRequired: "record-reference-unselected-required",
  ...
  recordReferenceUnselectedOptional: "record-reference-unselected-optional",
