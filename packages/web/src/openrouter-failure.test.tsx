...
const genericMessages: Record<TransportErrorCategory, string> = {
  ...
  "unrecognized-response": "OpenRouter returned an unrecognized response.",
  "output-limit": "OpenRouter stopped at the output limit.",
  "content-policy": "OpenRouter stopped for content policy.",
