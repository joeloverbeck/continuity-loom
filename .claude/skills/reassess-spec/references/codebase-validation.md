...
For classification (d), apply a stronger variant: verify each "accepted" claim actually landed in the codebase. An accepted-but-unredeemed claim with no delivering citation is a HIGH Issue (silent-retcon risk).
