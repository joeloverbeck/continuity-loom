...
(Continuity Loom has no `archive/specs/` or implementation-order ledger — leave the file at `specs/<ID>.md` with its Status flipped. If those conventions are introduced later, add the archival move here.)
