...
- **hardening / anti-contamination** — strengthen an existing system against drift, weak proof, or prompt-context contamination (accepted prose, rejected/superseded candidates, or auto-derived summaries leaking into compiled prompt context — see `docs/FOUNDATIONS.md` and `docs/ACTIVE-DOCS.md`).
...
- the **authority-ordered read list**, following Loom's hierarchy in `docs/ACTIVE-DOCS.md`: `docs/FOUNDATIONS.md` (constitution) → product/user-facing (`README.md`, `docs/user-guide.md`) → prompt/compiler/validation/schema (`docs/compiler-contract.md`, `docs/prompt-template.md`, `docs/prompt-template-rationale.md`, `docs/story-record-schema.md`) → stress/demo/regression (`docs/stress-suite.md`, `docs/stress-coverage-matrix.md`, `docs/demo-blocker-recipes.md`) → agent/process (`AGENTS.md`, `CLAUDE.md`, `docs/archival-workflow.md`, `tickets/README.md`), then relevant `reports/`, `specs/`, `archive/`. Give each entry a one-line reason it is load-bearing for *this* target;
