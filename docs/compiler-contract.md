...
1. Versioned candidate constants in `packages/core/src/compiler/change-review/`, governed transitionally by `docs/FOUNDATIONS.md`, issue #133, issue #135, and this contract.
